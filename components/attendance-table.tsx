...
export function AttendanceTable({
  ...
  const getAttendanceBadge = (days: number) => {
    if (days >= 20)
      return (
        <span className="bg-green-100 text-green-700 hover:bg-green-100">
          Excellent
        </span>
      );
    if (days >= 15)
      return (
        <span className="bg-blue-100 text-blue-700 hover:bg-blue-100">
          Good
        </span>
      );
    if (days >= 10)
      return (
        <span className="bg-amber-100 text-amber-700 hover:bg-amber-100">
          Fair
        </span>
      );
    return (
      <span className="bg-red-100 text-red-700 hover:bg-red-100">Poor</span>
    );
  };
  ...
  const employeeHistory = selectedEmployee
    ? getEmployeeHistory(selectedEmployee.userId)
    : [];
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div className="bg-purple-50 rounded-lg p-4">
                ...
                <div className="text-2xl font-bold text-purple-900">
                  {selectedEmployee?.averageClockInTime}
                </div>
              </div>
            </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-500">
                        Day {employeeHistory.length - index}
                      </div>
                    </div>
                  </div>
